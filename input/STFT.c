...
{
  static const double varargin_2[1024] = {0.08000000000000002,
                                          0.08000867630758929,
                                          0.08003470490305986,
                                          0.08007808480453327,
                                          0.08013881437558606,
                                          ...
                                          0.08000867630758929,
                                          0.08000000000000002};
  obj->pObj.isInitialized = 0;
  if (obj->pObj.isInitialized == 1) {
    obj->pObj.TunablePropsChanged = true;
  }
  memcpy(&obj->pObj.Window[0], &varargin_2[0], 1024U * sizeof(double));
  obj->pObj.matlabCodegenIsDeleted = false;
...
void STFT_step(dsp_STFT *obj, const emxArray_real_T *u, emxArray_creal_T *y)
{
  ...
  if (obj->pObj.isInitialized != 1) {
    ...
    obj->pObj.inputVarSize[0].f1[1] = 1U;
    for (k = 0; k < 6; k++) {
      obj->pObj.inputVarSize[0].f1[k + 2] = 1U;
    }
    obj->pObj.pBuff.pBuffer.isInitialized = 0;
    obj->pObj.pBuff.pBuffer.matlabCodegenIsDeleted = false;
    obj->pObj.pBuff.matlabCodegenIsDeleted = false;
    memcpy(&obj->pObj.pWindow[0], &obj->pObj.Window[0], 1024U * sizeof(double));
    obj->pObj.isSetupComplete = true;
    obj->pObj.TunablePropsChanged = false;
    if (obj->pObj.pBuff.pBuffer.isInitialized == 1) {
      obj->pObj.pBuff.pBuffer.ReadPointer = 1;
      obj->pObj.pBuff.pBuffer.WritePointer = 2;
      obj->pObj.pBuff.pBuffer.CumulativeOverrun = 0;
      obj->pObj.pBuff.pBuffer.CumulativeUnderrun = 0;
      memset(&obj->pObj.pBuff.pBuffer.Cache[0], 0, 1025U * sizeof(double));
    }
  }
  if (obj->pObj.TunablePropsChanged) {
    obj->pObj.TunablePropsChanged = false;
    memcpy(&obj->pObj.pWindow[0], &obj->pObj.Window[0], 1024U * sizeof(double));
  }
  ...
  if (obj->pObj.pBuff.pBuffer.isInitialized != 1) {
    obj->pObj.pBuff.pBuffer.isInitialized = 1;
    obj->pObj.pBuff.pBuffer.inputVarSize[0].f1[0] = (unsigned int)u->size[0];
    obj->pObj.pBuff.pBuffer.inputVarSize[0].f1[1] = 1U;
    for (k = 0; k < 6; k++) {
      obj->pObj.pBuff.pBuffer.inputVarSize[0].f1[k + 2] = 1U;
    }
    obj->pObj.pBuff.pBuffer.isSetupComplete = true;
    obj->pObj.pBuff.pBuffer.ReadPointer = 1;
    obj->pObj.pBuff.pBuffer.WritePointer = 2;
    obj->pObj.pBuff.pBuffer.CumulativeOverrun = 0;
    obj->pObj.pBuff.pBuffer.CumulativeUnderrun = 0;
  ...
  obj->pObj.pBuff.pBuffer.ReadPointer = rPtr;
  yk = obj->pObj.pBuff.pBuffer.WritePointer;
  n = obj->pObj.pBuff.pBuffer.ReadPointer;
  if ((yk >= 0) && (n < yk - MAX_int32_T)) {
    yk = MAX_int32_T;
  } else if ((yk < 0) && (n > yk - MIN_int32_T)) {
    yk = MIN_int32_T;
  } else {
    yk -= n;
  }
  ...
  n = obj->pObj.pBuff.pBuffer.WritePointer;
  if ((yk < 0) && (n < MIN_int32_T - yk)) {
    yk = MIN_int32_T;
  } else if ((yk > 0) && (n > MAX_int32_T - yk)) {
    yk = MAX_int32_T;
  } else {
    yk += n;
  }
